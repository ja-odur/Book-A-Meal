...
class TestMenu(unittest.TestCase):
    ...
    def test_create_order_failure(self):
        order = dict(meal3=[1, 'rice and posho', 5000], caterer='default')
    ...
    def test_modify_order(self):
        order = dict(meal=[1, 'rice and posho', 5000], caterer='default3')
        modified_order = dict(meal=[1, 'rice and posho_modified', 5000], caterer='default3')
        ...
        get_response = self.tester.put('api/v1/orders/1', content_type="application/json", data=json.dumps(modified_order))
    ...
    def test_get_all_orders_successful(self):
        order = dict(meal=[1, 'rice and posho', 5000], caterer='default4')
